...
<main x-data="container">
    <div class="max-w-screen-xl mx-auto py-20 px-6">
        ...
        <form @submit.prevent="submit">
            ...
            <div x-if="properties.data.sesi_pesanan != null">
            ...
            <div class="grid grid-cols-10 justify-stretch gap-4 w-full">
                <div class="col-span-6">
                    <div class="bg-gray-100 rounded p-6">
                        ...
                        <div class="w-full mb-4">
                            <label for="" class="font-sans text-base text-gray-600 mb-2 block">Nominal Dibayarkan</label>
...
<script type="text/javascript">
    document.addEventListener('alpine:init', () => {
        ...
        const actions = {
            "submit": function () {
                console.log(this.properties.form.bukti);
                ...
                if(Object.keys(this.properties.errors).length < 1) {
                    ...
                    axios
                        ...
                        .then(response => window.location.href = this.properties.sites.api_url + '/pelanggan/pesanan')
