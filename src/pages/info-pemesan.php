...
<main x-data="container">
                ...
                <div class="col-span-6">
                    <div class="bg-gray-100 rounded p-6">
                        ...
                        <div class="w-full mb-4">
                            ...
                            <textarea placeholder="Ketik lokasi penjemputan sedetail mungkin..." x-model="properties.form.titik_jemput" class="w-full bg-white text-gray-700 font-sans font-normal outline outline-0 border-2 text-sm px-3 py-3 rounded-md border-gray-200 focus:border-gray-400" cols="30" rows="5" x-text="properties.form.titik_jemput"></textarea>
                        </div>
    ...
    <div x-show="properties.sites.show_map">
        <div  tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-6xl mx-auto max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="flex items-start justify-between p-4 border-b rounded-t">
                        ...
                        <button @click="properties.sites.show_map = false" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center" data-modal-hide="defaultModal">
                    ...
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                        <button @click="properties.sites.show_map = false" data-modal-hide="defaultModal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Pilih</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        Alpine.data('container',
            () => ({
                ...
                "init": function() {
                    ...
                    mapboxgl.accessToken = 'pk.eyJ1Ijoia3VteWFrdW0iLCJhIjoiY2tpcWhhaXRlMDlnMDJ0b3pwbTNvaDl4MSJ9.PhflJtxgdetwjV3eRmG6EQ';
