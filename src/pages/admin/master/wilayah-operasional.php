<?php $listDaerahOperasional = app()->getManager()->getService('DaerahOperasionalService')->listDaerahOperasional();?>
<nav class="block w-full max-w-full bg-transparent text-white shadow-none transition-all px-0 py-1 border-b-2">
    <div class="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
        <h2 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-relaxed text-gray-900">Wilayah Operasional</h2>
        ...
        <div class="xl:col-span-2">
            <div class="flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md overflow-hidden">
                <div class="relative bg-clip-border rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none m-0 flex items-center justify-between p-6">
                    <div>
                        <h6 class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-gray-900 mb-1">Terdapat <?= count($listDaerahOperasional) ?> Daerah Operasional</h6>
                    </div>
                </div>
                <div class="p-6 overflow-x-scroll px-0 pt-0 pb-0">
                    <table class="w-full min-w-[640px] table-auto">
                        <thead>
                            <tr>
                                ...
                                <th class="border-b border-gray-200 py-3 px-6 text-left">
                                    <p class="block antialiased font-sans text-[11px] font-medium uppercase text-gray-400">Nama Wilayah (kota)</p>
                                </th>
                        ...
                        <tbody>
                        <?php
                        if (count($listDaerahOperasional) < 1) { ?>
                            <tr>
                        ...
                        foreach ($listDaerahOperasional as $daerah){ ?>
                            <tr>
                                ...
                                <td class="py-3 px-5 border-b border-gray-200">
                                    <p class="block antialiased font-sans text-xs font-medium text-gray-900 font-bold" ><?= $daerah->getNamaKota(); ?></p>
                                </td>
        ...
        <div>
            <div class="flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md p-6">
                <div class="relative bg-clip-border rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none m-0">
                    <h6 class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-gray-900 mb-2">Tambahkan Wilayah Baru</h6>
                </div>
                <form action="<?= site_url('admin/master/wilayah-operasional/simpan') ?>" class="mt-4" method="post">
                    <div class="w-full min-w-[200px] mb-4">
                        <label for="" class="font-sans text-base text-gray-500 mb-2 block">Nama Kota</label>
                        <input type="text" name="nama_kota" class="w-full bg-transparent text-gray-700 font-sans font-normal outline outline-0 border-2 text-sm px-3 py-3 rounded-md border-gray-200 focus:border-gray-400" autofocus>
                    </div>
