<?php $listDaerahOperasional = app()->getManager()->getService('DaerahOperasionalService')->listDaerahOpersional();?>
            ...
            <div class="flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md p-6">
                ...
                <form action="<?= site_url('admin/master/wilayah-operasional/simpan') ?>" class="mt-4" method="post">
                    <div class="w-full min-w-[200px] mb-4">
                        ...
                        <input type="text" name="nama_kota" class="w-full bg-transparent text-gray-700 font-sans font-normal outline outline-0 border-2 text-sm px-3 py-3 rounded-md border-gray-200 focus:border-gray-400">
                    </div>
