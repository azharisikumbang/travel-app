...
$listTarifByKategori = $app->getService('TiketService')->listTarifByKategori(50);
    ...
    <div class="mb-4 grid grid-cols-1 gap-6 xl:grid-cols-3">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <?php foreach($listTarif['list_tarif'] as $tarif): ?>
                                <div class="bg-clip-border rounded-xl bg-white text-gray-700 shadow-md p-6">
                                    ...
                                    <p class="font-sans text-base text-gray-500 mb-2 block">Rp <?= rupiah($tarif['tiket']) ?></p>
        ...
        <div>
            <div class="flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md p-6">
                ...
                <form action="<?= site_url('admin/master/tiket/simpan') ?>" class="mt-4" method="post">
