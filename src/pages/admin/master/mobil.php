...
if (count($listDriver) < 1)
{
    response()->redirectTo(
        'driver',
        ['status' => false, 'message' => 'Data driver harus ditambahkan terlebih dahulu.'],
        true
    );
    return;
}
    ...
    <nav class="block w-full max-w-full bg-transparent text-white shadow-none transition-all px-0 py-1 border-b-2">
        <div class="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
            <h2
                ...
                Master - Data Mobil Operasional</h2>
                    ...
                    <div
                        ...
                        <div>
                            <h6
                                ...
                                Terdapat <span x-text="properties.data.list_mobil.length"></span> Data Mobil</h6>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <template x-for="(item, index) in properties.data.list_mobil" :key="index">
                                        <tr>
                                            ...
                                            <td class="py-3 px-5 border-b border-gray-200">
                                                <p class="block antialiased font-sans text-xs font-medium text-gray-900 font-bold"
                                                    x-text="item.plat_nomor"></p>
                                            </td>
                                            <td class="py-3 px-5 border-b border-gray-200">
                                                <p class="block antialiased font-sans text-xs font-medium text-gray-900 font-bold"
                                                    x-text="item.jumlah_kursi + ' kursi'"></p>
                                            </td>
                                            <td class="py-3 px-5 border-b border-gray-200">
                                                <p class="block antialiased font-sans text-xs font-medium text-gray-900 font-bold"
                                                    x-text="item.driver.nama"></p>
                                            </td>
                                            <td class="py-3 px-5 border-b border-gray-200 flex justify-end gap-2">
                                                ...
                                                <button class="bg-red-500 text-white rounded px-4 py-1 font-sans center"
                                                    @click="hapusData(item)">Hapus</button>
                                            </td>
                                        </tr>
                                    </template>
                                </tbody>
                    ...
                    <div class="flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md p-6">
                        <div
                            ...
                            <h6
                                ...
                                <span x-text="properties.sites.button_title"></span> Mobil
                            </h6>
                        </div>
                        <div class="w-full min-w-[200px] mb-4">
                            <label for="" class="font-sans text-base text-gray-500 mb-2 block">Merk <small
                                    class="text-gray-500" x-text="properties.sites.query_title"></small></label>
                            <input type="text" x-model="properties.form.merk"
                        ...
                        <div class="w-full min-w-[200px] mb-4">
                            ...
                            <input type="text" x-model="properties.form.plat_nomor"
                                class="w-full bg-transparent text-gray-700 font-sans font-normal outline outline-0 border-2 text-sm px-3 py-3 rounded-md border-gray-200 focus:border-gray-400">
                        </div>
                        <div class="w-full min-w-[200px] mb-4">
                            <label for="" class="font-sans text-base text-gray-500 mb-2 block">Jumlah Kursi
                                Penumpang</label>
                            <input type="number" x-model="properties.form.jumlah_kursi"
                                class="w-full bg-transparent text-gray-700 font-sans font-normal outline outline-0 border-2 text-sm px-3 py-3 rounded-md border-gray-200 focus:border-gray-400">
                        </div>
                        <div class="w-full min-w-[200px] mb-4">
                            <label for="" class="font-sans text-base text-gray-500 mb-2 block">Driver</label>
                            <select x-model="properties.form.driver"
                                class="w-full bg-transparent text-gray-700 font-sans font-normal outline outline-0 border-2 text-sm px-3 py-3 rounded-md border-gray-200 focus:border-gray-400">
