...
<main x-data="container">
    <nav class="block w-full max-w-full bg-transparent text-white shadow-none transition-all px-0 py-1 border-b-2">
        <div class="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
            <h2 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-relaxed text-gray-900">Master - Data Driver</h2>
                            ...
                            <table class="w-full min-w-[640px] table-auto">
                                ...
                                <tr>
                                    ...
                                    <th class="border-b border-gray-200 py-3 px-6 text-left">
                                        <p class="block antialiased font-sans text-[11px] font-medium uppercase text-gray-400">Nama</p>
                                    </th>
                                    <th class="border-b border-gray-200 py-3 px-6 text-left">
                                        <p class="block antialiased font-sans text-[11px] font-medium uppercase text-gray-400">Kontak</p>
                                    </th>
                                    <th class="border-b border-gray-200 py-3 px-6 text-left">
                                        <p class="block antialiased font-sans text-[11px] font-medium uppercase text-gray-400">Akun</p>
                                    </th>
                                ...
                                <template x-for="(driver, index) in properties.data.list_driver" :key="index">
                                    <tr>
                                        ...
                                        <td class="py-3 px-5 border-b border-gray-200">
                                            <p class="block antialiased font-sans text-xs font-medium text-gray-900 font-bold" x-text="driver.nama"></p>
                                        </td>
                                        <td class="py-3 px-5 border-b border-gray-200">
                                            <p class="block antialiased font-sans text-xs font-medium text-gray-900 font-bold" x-text="driver.kontak"></p>
                                        </td>
                                        <td class="py-3 px-5 border-b border-gray-200">
                                            <p class="block antialiased font-sans text-xs font-medium text-gray-900 font-bold" x-text="driver.akun.username"></p>
                                        </td>
                                        <td class="py-3 px-5 border-b border-gray-200 flex justify-end gap-2">
                                            <button class="bg-orange-400 text-white rounded px-4 py-1 font-sans center" @click="editData(driver)">Edit</button>
                                            <button class="bg-red-500 text-white rounded px-4 py-1 font-sans center" @click="hapusData(driver)">Hapus</button>
                                        </td>
                                    </tr>
                                </template>
                                </tbody>
                ...
                <form @submit.prevent="simpanData">
                    <div class="flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md p-6">
                        ...
                        <div class="w-full min-w-[200px] mb-4">
                            ...
                            <input type="text" x-model="properties.form.nama" class="w-full bg-transparent text-gray-700 font-sans font-normal outline outline-0 border-2 text-sm px-3 py-3 rounded-md border-gray-200 focus:border-gray-400" autofocus>
                        </div>
                        <div class="w-full min-w-[200px] mb-4">
                            <label for="" class="font-sans text-base text-gray-500 mb-2 block">Kontak</label>
                            <input type="text" x-model="properties.form.kontak" class="w-full bg-transparent text-gray-700 font-sans font-normal outline outline-0 border-2 text-sm px-3 py-3 rounded-md border-gray-200 focus:border-gray-400">
                        </div>
                        <div class="w-full min-w-[200px] mb-4">
                            <label for="" class="font-sans text-base text-gray-500 mb-2 block">Username</label>
                            <input type="text" x-model="properties.form.username" class="w-full bg-transparent text-gray-700 font-sans font-normal outline outline-0 border-2 text-sm px-3 py-3 rounded-md border-gray-200 focus:border-gray-400" :readonly="properties.sites.show_password_input == false">
                        </div>
                        <div class="w-full min-w-[200px] mb-4" x-show="properties.sites.show_password_input">
                            ...
                            <input type="password" x-model="properties.form.password" class="w-full bg-transparent text-gray-700 font-sans font-normal outline outline-0 border-2 text-sm px-3 py-3 rounded-md border-gray-200 focus:border-gray-400">
                        </div>
