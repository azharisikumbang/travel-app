<?php $listTipePenumpang = app()->getManager()->getService('TipePenumpangService')->listTipePenumpang();?>
<nav class="block w-full max-w-full bg-transparent text-white shadow-none transition-all px-0 py-1 border-b-2">
    <div class="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
        <h2 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-relaxed text-gray-900">Kategori Penumpang</h2>
    ...
    <div class="mb-4 grid grid-cols-1 gap-6 xl:grid-cols-3">
                ...
                <div class="p-6 px-0 pt-0 pb-0">
                    <table class="w-full min-w-[640px] table-auto">
                        ...
                        <tr>
                            ...
                            <th class="border-b border-gray-200 py-3 px-6 text-left">
                                <p class="block antialiased font-sans text-[11px] font-medium uppercase text-gray-400">Nama Kategori</p>
                            </th>
                            <th class="border-b border-gray-20 py-3 px-6 text-left"></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php if(count($listTipePenumpang) < 1): ?>
                            <tr>
                        ...
                        <?php else:
                            $no = 1;
                            foreach ($listTipePenumpang as $tipePenumpang): ?>
                                <tr>
                                    ...
                                    <td class="py-3 px-5 border-b border-gray-200">
                                        <p class="block antialiased font-sans text-xs font-medium text-gray-900 font-bold" ><?= $tipePenumpang->getTipePenumpang(); ?></p>
                                    </td>
        ...
        <div>
            <div class="flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md p-6">
                ...
                <form action="<?= site_url('admin/master/kategori-penumpang/simpan') ?>" class="mt-4" method="post">
                    <div class="w-full min-w-[200px] mb-4">
                        <label for="" class="font-sans text-base text-gray-500 mb-2 block">Nama Kategori</label>
                        <input type="text" name="kategori_penumpang" class="w-full bg-transparent text-gray-700 font-sans font-normal outline outline-0 border-2 text-sm px-3 py-3 rounded-md border-gray-200 focus:border-gray-400" autofocus>
                    </div>
