...
<section class="max-w-screen-2xl mx-auto p-2 sm:py-20 flex flex-wrap">
    <aside class='w-full sm:w-3/12' x-data="{ show : true }">
        <div class="border rounded-lg p-4 shadow-md">
            ...
            <div x-show="show" class="border-t border-t-2">
    ...
    <main class="sm:px-8 mt-8 sm:mt-0 w-full sm:w-9/12">
