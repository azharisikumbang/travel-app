...
<!--                    <img src="/material-tailwind-dashboard-react/img/logo-ct.png" class="inline-block relative object-cover object-center w-9 h-9 rounded-md">-->
            ...
            <div class="m-4">
                <ul class="mb-4 flex flex-col gap-1">
                    <li>
                        <a aria-current="page" class="active" href="<?= site_url('admin/dashboard') ?>">
                    ...
                    <li>
                        <a class="" href="<?= site_url('admin/pesanan') ?>"><button class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize" type="button">
                                ...
                                <p class="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">Pesanan</p>
                            </button>
                        </a>
                    </li>
                    <li>
