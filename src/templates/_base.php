        ...
        <div class="mb-4 w-full flex justify-between">
            <div class="">
                ...
                <div class="flex justify-between">
                    ...
                    <button type="button" @click="cari" class="px-4 cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm">Cari Nomor Pesanan..</button>
                </div>
            </div>
            <div class="w-8/12">
